...
const HadithPage: React.FC = () => {
  ...
  // Sample Hadith data
    ...
    {
      id: 13,
      text: 'البيعان بالخيار ما لم يتفرقا، فإن صدقا وبينا بورك لهما في بيعهما، وإن كتما وكذبا محقت بركة بيعهما',
      narrator: 'حكيم بن حزام رضي الله عنه',
      source: 'صحيح البخاري',
      book: 'كتاب البيوع',
      chapter: 'باب البيعان بالخيار',
      number: '2079',
      grade: 'صحيح',
      category: 'المعاملات'
    },
    ...
    {
      id: 15,
      text: 'لا يحل مال امرئ مسلم إلا بطيب نفس منه',
      narrator: 'عمران بن حصين رضي الله عنه',
      source: 'سنن الدارمي',
      book: 'كتاب البيوع',
      chapter: 'باب في أخذ المال بحقه',
      number: '2533',
      grade: 'حسن',
      category: 'المعاملات'
    },
    {
      id: 16,
      text: 'من صلى علي صلاة واحدة صلى الله عليه بها عشراً',
      narrator: 'عبد الله بن مسعود رضي الله عنه',
      source: 'صحيح مسلم',
      book: 'كتاب الصلاة',
      chapter: 'باب الصلاة على النبي',
      number: '408',
      grade: 'صحيح',
      category: 'العبادات'
    },
    ...
    {
      id: 20,
      text: 'الصلوات الخمس والجمعة إلى الجمعة كفارات لما بينهن',
      narrator: 'أبو هريرة رضي الله عنه',
      source: 'صحيح مسلم',
      book: 'كتاب الطهارة',
      chapter: 'باب الصلوات الخمس',
      number: '233',
      grade: 'صحيح',
      category: 'العبادات'
    }
